...
Citizen.CreateThread(function()
	while true do
		...
		if GetDistanceBetweenCoords(coords, Config.MarkerCoords.x, Config.MarkerCoords.y, Config.MarkerCoords.z, false) < 15.0 then
			isNear = true
		else
			isNear = false
		end

		if GetDistanceBetweenCoords(coords, Config.MarkerCoords.x, Config.MarkerCoords.y, Config.MarkerCoords.z, false) < 2.0 then
			isInMarker = true
		else
			isInMarker = false
		end
